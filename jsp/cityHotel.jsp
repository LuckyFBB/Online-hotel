...
<div class="banner-bottom">
	<div class="container">
    	<div class="banner-bottom-grids">
        	<s:iterator value="#session.cityHotelList" status="status">
           		<div class="col-md-3 banner-bottom-grid">
                	...
                	<div class="banner-bottom-grid-info">
                    	...
                    	<div class="col-xs-8 banner-bottom-grid-infor">
                        	<h3>名字：<s:property value="hotelName"/></h3>
                    	</div>
                    	<div class="clearfix"></div>
                    	<p class="vel"><s:property value="intro"/></p>
                    	<div class="more m1"><s:a href="findHotel.action?hotelId=%{hotelId}">查看酒店详情</s:a></div>
                	</div>
            	</div>
        	</s:iterator>
        	<div class="clearfix"></div>
